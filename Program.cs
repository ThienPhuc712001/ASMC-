...
using SpringHeroBank1;
using SpringHeroBank1.Entity;
using SpringHeroBank1.Repository;
class Program
    {
        ...
        static void ViewTransactions(User user)
        {
            ...
            {
                Console.WriteLine($"Type: {transaction.TransactionType}, Amount: {transaction.Amount}, Date: {transaction.TransactionDate}");
            }
            Console.ReadLine();
        }
