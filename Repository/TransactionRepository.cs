...
public class TransactionRepository: ITransactionRepository
{
    ...
    public void AddTransaction(Transaction transaction)
    {
        try
        {
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand("INSERT INTO Transactions (AccountNumber, TransactionType, Amount, TransactionDate) VALUES (@AccountNumber, @TransactionType, @Amount, @TransactionDate)", conn);
    ...
    public List<Transaction> GetTransactionsByAccountNumber(string accountNumber, int pageNumber, int pageSize)
    {
        ...
        try
        {
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand("SELECT * FROM Transactions WHERE AccountNumber = @AccountNumber ORDER BY TransactionDate DESC LIMIT @Offset, @PageSize", conn);
    ...
    public List<Transaction> GetAllTransactions()
    {
        ...
        try
        {
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand("SELECT * FROM Transactions ORDER BY TransactionDate DESC", conn);
